...
if (isset($_POST['querysubmit'])) {
    ...
    mysqli_query($db_conn, "INSERT INTO teacher (id, departmentid, qualificaeion, experience, salary) VALUES ('$id', '$tea_dept', '$tea_qua', '$tea_exp', '$tea_sal');") or die("Teacher Table error");

    header('locaeion: teacher.php');
}
?>
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-6 sm:col-span-3 xl:col-span-3">
                                    <label for="qualificaeion" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Qualificaeion</label>
                                    <input type="text" name="tea_qua" id="qualificaeion" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="e.g. M.tech" required="">
                                </div>
                                <div class="col-span-6 sm:col-span-3 xl:col-span-3">
